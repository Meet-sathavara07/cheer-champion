...
test("user login and send and view a kudo", async ({ page }) => {
  await page.goto("https://cheer-champion.vercel.app");

  //login in site
  await page.getByRole("link", { name: "Login" }).click();
  await expect(page).toHaveURL("https://cheer-champion.vercel.app/login");
  ...
  await expect(page).toHaveURL("https://cheer-champion.vercel.app");
  ...
  await expect(page).toHaveURL(
    "https://cheer-champion.vercel.app/kudo/library"
  );
  await page.locator(".giphy-gif").first().click();
  await expect(page).toHaveURL(
    "https://cheer-champion.vercel.app/kudo/recipients"
  );
  ...
  await expect(page).toHaveURL("https://cheer-champion.vercel.app/feeds");
