...
interface KudoDeleteConfirmModalProps {
  isOpen: boolean;
  isLoading: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const KudoDeleteConfirmModal: React.FC<KudoDeleteConfirmModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
      ...
      <div className="relative w-full max-w-sm lg:max-w-lg bg-white rounded-lg shadow-lg z-20">
        ...
        <div className="px-10 pb-8 pt-2 flex flex-col items-center">
          <p className="text-xs lg:text-base font-medium font-libre text-center text-gray-600 mb-0 lg:mb-5">
            {t("deleteModal.deleteKudoMessage")}
          </p>
...
export default KudoDeleteConfirmModal;
